...
// --- 硬编码配置 ---
// UUID，同时用作订阅路径。
const authToken = '67c85282-ddcb-4582-bfc4-34cdd727ec75';
// 用来访问cloudflare托管的网站
const fallbackAddress = '5858598.xyz';
const fallbackPort = '443';
// SOCKS5 代理配置。留空则禁用。格式: user:pass@host:port
const socks5Config = '';

const directDomains = [
    { name: "cloudflare.182682.xyz", domain: "cloudflare.182682.xyz" }, { name: "youxuan.cf.090227.xyz", domain: "youxuan.cf.090227.xyz" },
    { domain: "freeyx.cloudflare88.eu.org" }, { domain: "bestcf.top" }, { domain: "cf.cloudflare.182682.xyz" }, { domain: "www.shopify.com" },
    { domain: "cf.0sm.com" }, { domain: "cf.090227.xyz" }, { domain: "cf.zhetengsha.eu.org" }, { domain: "store.ubi.com" },
    { domain: "staticdelivery.nexusmods.com" }, { domain: "cfip.1323123.xyz" }, { domain: "cloudflare-dl.byoip.top" }, { domain: "cloudflare-ip.mofashi.ltd" },
    { domain: "cf.tencentapp.cn" }, { domain: "cname.xirancdn.us" }, { domain: "cf.877774.xyz" }, { domain: "saas.sin.fan" },
    { domain: "cdn.tzpro.xyz" }, { domain: "bestcf.030101.xyz" }, { domain: "xn--b6gac.eu.org" }
];
